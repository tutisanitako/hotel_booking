...
<head>
    ...
    <title>{{ config('app.name', 'EasySet24') }} - Hotel Manager - @yield('title', 'Dashboard')</title>
    ...
    <div class="d-flex">
        ...
        <div class="sidebar" style="width: 250px;">
            ...
            <nav class="nav flex-column">
                ...
                <a class="nav-link {{ request()->routeIs('hotel-manager.hotels.*') ? 'active' : '' }}" 
                   href="{{ route('hotel-manager.hotels.index') }}">
                    <i class="fas fa-hotel"></i> My Hotels
                </a>
                
                <a class="nav-link {{ request()->routeIs('hotel-manager.bookings.*') ? 'active' : '' }}" 
                   href="{{ route('hotel-manager.bookings.index') }}">
